...
parties = [
    ...
    Party(67, 67, "43もこクロス", 58, 247, 83, 1702, 78, 1699, 40, 197, 69, 683, 79, 252, Owner.mine).toSet(),
    Party(68, 68, "43もこクロス2", 58, 247, 77, 1702, 78, 1699, 40, 197, 69, 683, 79, 252, Owner.mine).toSet(),
    Party(69, 69, "44もこカイリュー", 40, 197, 69, 683, 79, 252, 58, 247, 72, 264, 81, 211, Owner.mine).toSet(),
    ...
    Party(72, 72, "47もこリンダー", 58, 247, 88, 723, 85, 252, 71, 583, 90, 1176, 28, 273, Owner.mine).toSet(),
