...
class AbilityText extends AbilityTooltip {
  AbilityText(
    ...
    TooltipTriggerMode? triggerMode,
          ...
          ability: ability,
          child:
              Text(showHatena && ability.id == 0 ? '?' : ability.displayName),
          triggerMode: triggerMode,
        );
}
  ...
  MoveTooltip({
    ...
    TooltipTriggerMode? triggerMode,
          ...
          richMessage: TextSpan(children: [
            ...
            TextSpan(
                text: move.damageClass.id == 1
                    ? ' ${loc.commonMoveStatus}'
                    : move.damageClass.id == 2
                        ? ' ${loc.commonMovePhysical}'
                        : move.damageClass.id == 3
                            ? ' ${loc.commonMoveSpecial}'
                            : ' ?'),
            TextSpan(
                text:
                    ' ${loc.commonMovePower} : ${move.power} ${loc.commonMoveAccuracy} : ${move.accuracy}'),
