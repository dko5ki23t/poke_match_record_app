...
class BuffDebuff {
  ...
  static const Map<int, Tuple3<String, Color, bool>> _nameColorTurnMap = {
    0:  Tuple3('', Colors.black, false),
    1:  Tuple3('こうげき1.3倍', Colors.red, false),
    2:  Tuple3('ぼうぎょ1.3倍', Colors.red, false),
    3:  Tuple3('とくこう1.3倍', Colors.red, false),
    4:  Tuple3('とくぼう1.3倍', Colors.red, false),
    5:  Tuple3('すばやさ1.5倍', Colors.red, false),
    6:  Tuple3('相手わざ命中率0.8倍', Colors.red, false),
    7:  Tuple3('命中率1.3倍', Colors.red, false),
    8:  Tuple3('ほのおわざ威力1.5倍', Colors.red, false),
    9:  Tuple3('わざ追加効果発動確率2倍', Colors.red, false),
    10: Tuple3('すばやさ2倍', Colors.red, false),
    11: Tuple3('こうげき2倍', Colors.red, false),
    12: Tuple3('こうげき1.5倍', Colors.red, false),
    13: Tuple3('物理技命中率0.8倍', Colors.blue, false),
    14: Tuple3('ポワルンのすがた', Colors.orange, false),
    15: Tuple3('たいようのすがた', Colors.orange, false),
    16: Tuple3('あまみずのすがた', Colors.orange, false),
    17: Tuple3('ゆきぐものすがた', Colors.orange, false),
    18: Tuple3('こうげき1.5倍(やけど無視)', Colors.red, false),
    19: Tuple3('ぼうぎょ1.5倍', Colors.red, false),
    20: Tuple3('くさわざ威力1.5倍', Colors.red, false),
    21: Tuple3('ほのおわざ威力1.5倍', Colors.red, false),
    22: Tuple3('みずわざ威力1.5倍', Colors.red, false),
    23: Tuple3('むしわざ威力1.5倍', Colors.red, false),
    24: Tuple3('相手わざ命中率0.5倍', Colors.red, false),
    25: Tuple3('すばやさ2倍', Colors.red, false),
    26: Tuple3('同性への威力1.25倍/異性への威力0.75倍', Colors.red, false),
    27: Tuple3('ほのおわざ被ダメ半減計算・やけどダメ半減', Colors.red, false),
    28: Tuple3('ほのおわざ受ける威力1.25倍', Colors.blue, false),
    29: Tuple3('パンチわざ威力1.2倍', Colors.red, false),
    30: Tuple3('タイプ一致ボーナス2倍', Colors.red, false),
    31: Tuple3('すばやさ1.5倍(まひ無視)', Colors.red, false),
    32: Tuple3('すべてのわざタイプ→ノーマル', PokeTypeColor.normal, false),
    33: Tuple3('急所時ダメージ1.5倍', Colors.red, false),
    34: Tuple3('相手こうげき以外ダメージ無効', Colors.red, false),
    35: Tuple3('出すわざ/受けるわざ必中', Colors.red, false),
    36: Tuple3('同優先度行動で最後に行動', Colors.red, false),
    37: Tuple3('60以下威力わざの威力1.5倍', Colors.red, false),
    38: Tuple3('もちものの効果なし', Colors.red, false),
    39: Tuple3('相手とくせい無視', Colors.red, false),
    40: Tuple3('急所率アップ+1', Colors.red, false),
    41: Tuple3('急所率アップ+2', Colors.red, false),
    42: Tuple3('急所率アップ+3', Colors.red, false),
    43: Tuple3('相手のランク補正無視', Colors.red, false),
    44: Tuple3('タイプ相性いまひとつ時ダメージ2倍', Colors.red, false),
    45: Tuple3('こうかばつぐん被ダメージ0.75倍', Colors.red, false),
    46: Tuple3('こうげき・すばやさ0.5倍', Colors.blue, false),
    47: Tuple3('反動わざ威力1.2倍', Colors.red, false),
    48: Tuple3('ネガフォルム', Colors.orange, false),
    49: Tuple3('ポジフォルム', Colors.orange, false),
    50: Tuple3('わざの追加効果なし・威力1.3倍', Colors.red, false),
    51: Tuple3('こうげき・とくこう半減', Colors.blue, false),
    52: Tuple3('おもさ2倍', Colors.orange, false),
    53: Tuple3('おもさ0.5倍', Colors.orange, false),
    54: Tuple3('受けるダメージ0.5倍', Colors.red, false),
    55: Tuple3('ぶつりわざ威力1.5倍', Colors.red, false),
    56: Tuple3('とくしゅわざ威力1.5倍', Colors.red, false),
    57: Tuple3('こな・ほうし・すなあらしダメージ無効', Colors.red, false),
    58: Tuple3('相手のへんかわざ命中率50', Colors.red, false),
    59: Tuple3('最後行動時わざ威力1.3倍', Colors.red, false),
    60: Tuple3('かべ・みがわり無視', Colors.red, false),
    61: Tuple3('へんかわざ優先度+1(あくタイプには無効)', Colors.red, false),
    62: Tuple3('いわ・じめん・はがねわざ威力1.3倍', Colors.red, false),
    63: Tuple3('ダルマモード', Colors.orange, false),
    64: Tuple3('命中率1.1倍', Colors.red, false),
    65: Tuple3('ぼうぎょ2倍', Colors.red, false),
    66: Tuple3('弾のわざ無効', Colors.red, false),
    67: Tuple3('かみつきわざ威力1.5倍', Colors.red, false),
    68: Tuple3('ノーマルわざ→こおりわざ＆こおりわざ威力1.2倍', Colors.orange, false),
    69: Tuple3('ブレードフォルム', Colors.orange, false),
    70: Tuple3('シールドフォルム', Colors.orange, false),
    71: Tuple3('ひこうわざ優先度+1', Colors.red, false),
    72: Tuple3(' はどうわざ威力1.5倍', Colors.red, false),
    73: Tuple3('ぼうぎょ1.5倍', Colors.red, false),
    74: Tuple3('直接攻撃威力1.3倍', Colors.red, false),
    75: Tuple3('ノーマルわざ→フェアリーわざ＆フェアリーわざ威力1.2倍', Colors.red, false),
    76: Tuple3('ノーマルわざ→ひこうわざ＆ひこうわざ威力1.2倍', Colors.red, false),
    77: Tuple3('あくわざ威力1.33倍', Colors.red, false),
    78: Tuple3('フェアリーわざ威力1.33倍', Colors.red, false),
    79: Tuple3('あくわざ威力0.75倍', Colors.blue, false),
    80: Tuple3('フェアリーわざ威力0.75倍', Colors.blue, false),
    81: Tuple3('どく・もうどく状態へのこうげき急所率100%', Colors.red, false),
    82: Tuple3('こうたい後ポケモンへのこうげき・とくこう2倍', Colors.red, false),
    83: Tuple3('相手ほのおわざこうげき・とくこう0.5倍', Colors.red, false),
    84: Tuple3('みずわざこうげき・とくこう2倍', Colors.red, false),
    85: Tuple3('はがねわざこうげき・とくこう1.5倍', Colors.red, false),
    86: Tuple3('音わざタイプ→みず', Colors.orange, false),
    87: Tuple3('かいふくわざ優先度+3', Colors.red, false),
    88: Tuple3('ノーマルわざ→でんきわざ＆でんきわざ威力1.2倍', Colors.red, false),
    89: Tuple3('たんどくのすがた', Colors.orange, false),
    90: Tuple3('むれたすがた', Colors.orange, false),
    91: Tuple3('ばけたすがた', Colors.orange, false),
    92: Tuple3('ばれたすがた', Colors.orange, false),
    93: Tuple3('サトシゲッコウガ', Colors.orange, false),
    94: Tuple3('10%フォルム', Colors.orange, false),
    95: Tuple3('50%フォルム', Colors.orange, false),
    96: Tuple3('パーフェクトフォルム', Colors.orange, false),
    97: Tuple3('相手の優先度1以上わざ無効', Colors.red, false),
    98: Tuple3('直接攻撃被ダメージ半減', Colors.red, false),
    99: Tuple3('ほのおわざ被ダメージ2倍', Colors.blue, false),
    100: Tuple3('こうかばつぐんわざダメージ1.25倍 ', Colors.red, false),
    101: Tuple3('わざの対象相手が変更されない', Colors.red, false),
    102: Tuple3('うのみのすがた', Colors.orange, false),
    103: Tuple3('まるのみのすがた', Colors.orange, false),
    104: Tuple3('音わざ威力1.3倍 ',Colors.red, false),
    105: Tuple3('音わざ被ダメージ半減', Colors.red, false),
    106: Tuple3('とくしゅわざ被ダメージ半減', Colors.red, false),
    107: Tuple3('きのみ効果2倍', Colors.red, false),
    108: Tuple3('アイスフェイス', Colors.orange, false),
    109: Tuple3('ナイスフェイス', Colors.orange, false),
    110: Tuple3('こうげきわざ威力1.3倍 ',Colors.red, false),
    111: Tuple3('はがねわざ威力1.5倍 ',Colors.red, false),
    112: Tuple3('わざこだわり・こうげき1.5倍 ',Colors.red, false),
    113: Tuple3('まんぷくもよう', Colors.orange, false),
    114: Tuple3('はらぺこもよう', Colors.orange, false),
    115: Tuple3('直接こうげきのまもり不可', Colors.red, false),
    116: Tuple3('でんきわざ時こうげき・とくこう1.3倍 ',Colors.red, false),
    117: Tuple3('ドラゴンわざ時こうげき・とくこう1.5倍 ',Colors.red, false),
    118: Tuple3('ゴーストわざ被ダメ計算時こうげき・とくこう半減', Colors.red, false),
    119: Tuple3('いわわざ時こうげき・とくこう1.5倍 ',Colors.red, false),
    120: Tuple3('ナイーブフォルム', Colors.orange, false),
    121: Tuple3('マイティフォルム', Colors.orange, false),
    122: Tuple3('とくこう0.75倍 ', Colors.blue, false),
    123: Tuple3('ぼうぎょ0.75倍 ', Colors.blue, false),
    124: Tuple3('こうげき0.75倍 ', Colors.blue, false),
    125: Tuple3('とくぼう0.75倍 ', Colors.blue, false),
    126: Tuple3('こうげき1.33倍 ', Colors.red, false),
    127: Tuple3('とくこう1.33倍 ', Colors.red, false),
    128: Tuple3('切るわざ威力1.5倍 ', Colors.red, false),
    129: Tuple3('わざ威力10%アップ ', Colors.red, false),
    130: Tuple3('わざ威力20%アップ ', Colors.red, false),
    131: Tuple3('わざ威力30%アップ ', Colors.red, false),
    132: Tuple3('わざ威力40%アップ ', Colors.red, false),
    133: Tuple3('わざ威力50%アップ ', Colors.red, false),
    134: Tuple3('へんかわざ最後に行動＆相手のとくせい無視', Colors.red, false),
    135: Tuple3('とくぼう1.5倍 ', Colors.red, false),
    136: Tuple3('わざこだわり・とくこう1.5倍 ', Colors.red, false),
    137: Tuple3('とくこう2倍', Colors.red, false),
    138: Tuple3('こうげきわざのみ選択可・とくぼう1.5倍 ', Colors.red, false),
    139: Tuple3('とくぼう2倍', Colors.red, false),
    140: Tuple3('わざこだわり・すばやさ1.5倍 ', Colors.red, false),
    141: Tuple3('次に使うわざ命中率1.2倍 ', Colors.red, false),
    142: Tuple3('当ターン行動済み相手へのわざ命中率1.2倍 ', Colors.red, false),
    143: Tuple3('こうげきわざ時こうげき・とくこう2倍', Colors.red, false),
    144: Tuple3('すばやさ0.5倍 ', Colors.blue, false),
    145: Tuple3('相手わざ命中率0.9倍 ', Colors.red, false),
    146: Tuple3('ぶつりわざ威力1.1倍 ', Colors.red, false),
    147: Tuple3('とくしゅわざ威力1.1倍 ', Colors.red, false),
    148: Tuple3('ノーマルわざ威力1.3倍 ', Colors.red, false),
    149: Tuple3('ノーマルわざ威力1.2倍 ', Colors.red, false),
    150: Tuple3('ほのおわざ威力1.2倍 ', Colors.red, false),
    151: Tuple3('みずわざ威力1.2倍', Colors.red, false),
    152: Tuple3('でんきわざ威力1.2倍', Colors.red, false),
    153: Tuple3('くさわざ威力1.2倍', Colors.red, false),
    154: Tuple3('こおりわざ威力1.2倍', Colors.red, false),
    155: Tuple3('かくとうわざ威力1.2倍', Colors.red, false),
    156: Tuple3('どくわざ威力1.2倍', Colors.red, false),
    157: Tuple3('じめんわざ威力1.2倍', Colors.red, false),
    158: Tuple3('ひこうわざ威力1.2倍', Colors.red, false),
    159: Tuple3('エスパーわざ威力1.2倍', Colors.red, false),
    160: Tuple3('むしわざ威力1.2倍', Colors.red, false),
    161: Tuple3('いわわざ威力1.2倍', Colors.red, false),
    162: Tuple3('ゴーストわざ威力1.2倍', Colors.red, false),
    163: Tuple3('ドラゴンわざ威力1.2倍', Colors.red, false),
    164: Tuple3('あくわざ威力1.2倍', Colors.red, false),
    165: Tuple3('はがねわざ威力1.2倍', Colors.red, false),
    166: Tuple3('フェアリーわざ威力1.2倍', Colors.red, false),
    167: Tuple3('わざ威力1.2倍', Colors.red, false),
    168: Tuple3('こうげきわざダメージ1.3倍・自身HP1/10ダメージ', Colors.red, false),
    169: Tuple3('こうかばつぐん時ダメージ1.2倍', Colors.red, false),
    170: Tuple3('同じわざ連続使用ごとにダメージ+20%(MAX 200%)', Colors.red, false),
    171: Tuple3('バインド与ダメージ→最大HP1/6', Colors.red, false),
    172: Tuple3('すなあらしダメージ・こな・ほうし無効', Colors.red, false),
    173: Tuple3('直接こうげきに対して発動する効果無効', Colors.red, false),
    174: Tuple3('設置わざ効果無効', Colors.red, false),
    175: Tuple3('こうげき時10%ひるみ', Colors.red, false),
    176: Tuple3('みがわり', Colors.green, false),
    177: Tuple3('わざによるダメージでこうげき1段階上昇', Colors.red, false),
    178: Tuple3('パンチわざ非接触化・威力1.1倍', Colors.red, false),
    179: Tuple3('ボイスフォルム', Colors.orange, false),
    180: Tuple3('ステップフォルム', Colors.orange, false),
    181: Tuple3('', Colors.white, false),
    182: Tuple3('', Colors.white, false),
    183: Tuple3('', Colors.white, false),
    184: Tuple3('相手わざ必中・ダメージ2倍', Colors.blue, false),
    186: Tuple3('こうげきわざ威力1.2倍', Colors.red, false),
    189: Tuple3('へんしん', Colors.orange, false),
  };
  ...
  String get displayName => _nameColorTurnMap[id]!.item3 ? '${_nameColorTurnMap[id]!.item1} ($turns/?)' : _nameColorTurnMap[id]!.item1;
