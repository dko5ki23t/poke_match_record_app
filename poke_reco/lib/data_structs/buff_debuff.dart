...
//  static const int satoshiGekkoga = 93;   // サトシゲッコウガ
  ...
  static const Map<int, Tuple4<String, String, Color, int>> _nameColorTurnMap = {
    ...
    9:  Tuple4('わざ追加効果発動確率2倍', 'Additional effect chance of Move 2x',  Colors.red, 0),
    ...
    26: Tuple4('同性への威力1.25倍/異性への威力0.75倍', '1.25x power against same sex / 0.75x power against opposite sex', Colors.red, 0),
    27: Tuple4('ほのおわざ被ダメ半減計算・やけどダメ半減', 'Fire Move\'s damage damage calculation/Burn damage halved',  Colors.red, 0),
    28: Tuple4('ほのおわざ受ける威力1.25倍', 'Receiving Fire Move\'s power 1.25x', Colors.blue, 0),
    ...
    32: Tuple4('すべてのわざタイプ→ノーマル', 'All Move types -> Normal',  PokeTypeColor.normal, 0),
    33: Tuple4('急所時ダメージ1.5倍', 'Critical damage 1.5x', Colors.red, 0),
    34: Tuple4('相手こうげき以外ダメージ無効', 'Immunity to damage other than opponent\'s attacks',  Colors.red, 0),
    35: Tuple4('出すわざ/受けるわざ必中', 'Moves to send/Moves to receive are sure to hit', Colors.red, 0),
    36: Tuple4('同優先度行動で最後に行動', 'Act last with same priority action',  Colors.red, 0),
    37: Tuple4('60以下威力わざの威力1.5倍', '1.5x the power of Moves with a power of 60 or less', Colors.red, 0),
    ...
    43: Tuple4('相手のランク補正無視', 'Ignore opponent\'s Stat modifications',  Colors.red, 0),
    44: Tuple4('タイプ相性いまひとつ時ダメージ2倍', '2x damage when type compatibility is poor',  Colors.red, 0),
    45: Tuple4('こうかばつぐん被ダメージ0.75倍', '0.75x damage when Move whose type compatibility is great received', Colors.red, 0),
    ...
    50: Tuple4('わざの追加効果なし・威力1.3倍', 'No additional effect occurs when use Move and 1.3x power', Colors.red, 0),
    ...
    57: Tuple4('こな・ほうし・すなあらしダメージ無効', 'Nullifies damage from powders/Effect Spore/sandstorm',  Colors.red, 0),
    58: Tuple4('相手のへんかわざ命中率50', 'Accuracy of opponent\'s Status Move becomes 50',  Colors.red, 0),
    59: Tuple4('最後行動時わざ威力1.3倍', 'Move power 1.3x when you act at last in turns', Colors.red, 0),
    60: Tuple4('かべ・みがわり無視', 'Ignore Walls and SUBSTITUTE',  Colors.red, 0),
    61: Tuple4('へんかわざ優先度+1(あくタイプには無効)', 'Status Move\'s priority +1(Except for Dark type Pokémon)', Colors.red, 0),
    62: Tuple4('いわ・じめん・はがねわざ威力1.3倍', 'Rock/Ground/Steel Move power 1.5x', Colors.red, 0),
    ...
    68: Tuple4('ノーマルわざ→こおりわざ＆こおりわざ威力1.2倍', 'Normal Move types -> Ice and Ice Move power 1.2x', Colors.orange, 0),
    ...
    75: Tuple4('ノーマルわざ→フェアリーわざ＆フェアリーわざ威力1.2倍', 'Normal Move types -> Fairy and Fairy Move power 1.2x', Colors.red, 0),
    76: Tuple4('ノーマルわざ→ひこうわざ＆ひこうわざ威力1.2倍', 'Normal Move types -> Flying and Flying Move power 1.2x', Colors.red, 0),
    ...
    81: Tuple4('どく・もうどく状態へのこうげき急所率100%', '100% rate of Critical for Poisoning and badly Poisoning',  Colors.red, 0),
    82: Tuple4('こうたい後ポケモンへのこうげき・とくこう2倍', 'Attack/Special Attack 2x to Pokémon after change',  Colors.red, 0),
    83: Tuple4('相手ほのおわざこうげき・とくこう0.5倍', 'Opponent\'s Attack/Special Attack 0.5x when receive Fire Move', Colors.red, 0),
    84: Tuple4('みずわざこうげき・とくこう2倍', 'Attack/Special Attack 2x when using Water Move',  Colors.red, 0),
    85: Tuple4('はがねわざこうげき・とくこう1.5倍', 'Attack/Special Attack 2x when using Steel Move', Colors.red, 0),
    86: Tuple4('音わざタイプ→みず', 'Sound Move types -> Water',  Colors.orange, 0),
    87: Tuple4('かいふくわざ優先度+3', 'Recovery Moves priority +3', Colors.red, 0),
    88: Tuple4('ノーマルわざ→でんきわざ＆でんきわざ威力1.2倍', 'Normal Move types -> Electric and Electric Move power 1.2x', Colors.red, 0),
    ...
    97: Tuple4('相手の優先度1以上わざ無効', 'Disables opponent\'s Moves with priority 1 or above',  Colors.red, 0),
    98: Tuple4('直接攻撃被ダメージ半減', 'Direct attack with halved damage',  Colors.red, 0),
    99: Tuple4('ほのおわざ被ダメージ2倍', 'Fire Move received with damage 2x',  Colors.blue, 0),
    100: Tuple4('こうかばつぐんわざダメージ1.25倍', '1.25x damage when using Move whose type compatibility is great', Colors.red, 0),
    101: Tuple4('わざの対象相手が変更されない', 'Target of Moves does not change',  Colors.red, 0),
    ...
    105: Tuple4('音わざ被ダメージ半減', 'Sound Move received with halved damage',  Colors.red, 0),
    106: Tuple4('とくしゅわざ被ダメージ半減', 'Special Move received with halved damage',  Colors.red, 0),
    ...
    112: Tuple4('わざこだわり・こうげき1.5倍', 'Lock one Move and Attack 1.5x', Colors.red, 0),
    113: Tuple4('まんぷくもよう', 'Full Belly Mode',  Colors.orange, 0),
    114: Tuple4('はらぺこもよう', 'Hangry Mode',  Colors.orange, 0),
    115: Tuple4('直接こうげきのまもり不可', 'Direct attack passes through protection',  Colors.red, 0),
    116: Tuple4('でんきわざ時こうげき・とくこう1.3倍', 'Attack/Special Attack 1.3x when using Electric Move', Colors.red, 0),
    117: Tuple4('ドラゴンわざ時こうげき・とくこう1.5倍', 'Attack/Special Attack 1.5x when using Dragon Move',Colors.red, 0),
    118: Tuple4('ゴーストわざ被ダメ計算時こうげき・とくこう半減', 'Opponent\'s Attack/Special Attack 0.5x when receive Ghost Move',  Colors.red, 0),
    119: Tuple4('いわわざ時こうげき・とくこう1.5倍', 'Attack/Special Attack 1.5x when using Rock Move',Colors.red, 0),
    ...
    134: Tuple4('へんかわざ最後に行動＆相手のとくせい無視', 'Act at last in turns when using Status Move and ignore opponent\'s Ability',  Colors.red, 0),
    135: Tuple4('とくぼう1.5倍', 'Special Defense 1.5x', Colors.red, 0),
    136: Tuple4('わざこだわり・とくこう1.5倍', 'Lock one Move and Special Attack 1.5x', Colors.red, 0),
    137: Tuple4('とくこう2倍', 'Special Attack 2x',  Colors.red, 0),
    138: Tuple4('こうげきわざのみ選択可・とくぼう1.5倍', 'Special Defense 1.5x but cannot Status Moves', Colors.red, 0),
    139: Tuple4('とくぼう2倍', 'Special Defense 2x',  Colors.red, 0),
    140: Tuple4('わざこだわり・すばやさ1.5倍', 'Lock one Move and Speed 1.5x', Colors.red, 0),
    141: Tuple4('次に使うわざ命中率1.2倍', 'Accuracy 1.2x of Move use next', Colors.red, 0),
    142: Tuple4('当ターン行動済み相手へのわざ命中率1.2倍', 'Accuracy 1.2x to opponent acted in this turn', Colors.red, 0),
    143: Tuple4('こうげきわざ時こうげき・とくこう2倍', 'Attack/Special Attack 2x when using Move',  Colors.red, 0),
    144: Tuple4('すばやさ0.5倍', 'Speed 0.5x', Colors.blue, 0),
    145: Tuple4('相手わざ命中率0.9倍', 'Accuracy 0.9x of opponent\'s Move', Colors.red, 0),
    ...
    168: Tuple4('こうげきわざダメージ1.3倍・自身HP1/10ダメージ', 'Damage 1.3x of using attack Move and 1/10 of max HP is reduced', Colors.red, 0),
    169: Tuple4('こうかばつぐん時ダメージ1.2倍', '1.2x damage when using Move whose type compatibility is great', Colors.red, 0),
    170: Tuple4('同じわざ連続使用ごとにダメージ+20%(MAX 200%)', 'Damage +20%(MAX 200%) for each consecutive use of the same Move', Colors.red, 0),
    171: Tuple4('バインド与ダメージ→最大HP1/6', 'Damage dealt by Partially Trapped -> Max HP 1/6', Colors.red, 0),
    173: Tuple4('直接こうげきに対して発動する効果無効', 'Effects activated direct attack are disabled',  Colors.red, 0),
    ...
    177: Tuple4('わざによるダメージでこうげき1段階上昇', 'Attack rise 1 level due to damage caused by Moves', Colors.red, 0),
    178: Tuple4('パンチわざ非接触化・威力1.1倍', 'Punch Moves are non-contact/power 1.1x', Colors.red, 0),
  ...
  String get displayName {
    switch (PokeDB().language) {
      case Language.japanese:
        return _nameColorTurnMap[id]!.item4 > 0 ? '${_nameColorTurnMap[id]!.item1} ($turns/${_nameColorTurnMap[id]!.item4})' : _nameColorTurnMap[id]!.item1;
      case Language.english:
      default:
        return _nameColorTurnMap[id]!.item4 > 0 ? '${_nameColorTurnMap[id]!.item2} ($turns/${_nameColorTurnMap[id]!.item4})' : _nameColorTurnMap[id]!.item2;
    }
  }
